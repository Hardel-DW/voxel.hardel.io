          ...
          <NavigationMenuContent>
            <ul className="grid gap-3 p-6 md:w-[400px] lg:w-[500px] lg:grid-cols-[.75fr_1fr]">
                ...
                <NavigationMenuLink asChild>
                  ...
                  >
                    ...
                    <p className="text-sm leading-tight text-muted-foreground">
                      Developpe les mods de t'es rêves
                    </p>
                  </a>
                </NavigationMenuLink>
              </li>
              ...
              <ListItem href="/policy" title="Legal">
                Les mentions légales, la politique de confidentialité et les
            ...
            <div className="p-6 md:w-[400px] lg:w-[500px]">
              ...
              >
                <div className="text-xl font-medium text-white leading-none relative z-10">
                  Minecraft Modding - 1.20
                </div>
                <p className="line-clamp-2 text-sm leading-snug text-zinc-400">
                  Apprend a faire des mods avec Java en version 1.20 sous Forge
                  ou Fabric - Sans connaissance au préalable !
                </p>
              ...
              <ul className="grid gap-3 mt-3 lg:grid-cols-[.75fr_1fr]">
                ...
                <ListItem href="/docs/installation" title="Migrations">
                  Guide pour migrer ton mod vers une nouvelle version de
                  Minecraft
                </ListItem>
          ...
          <NavigationMenuContent>
            <ul className="grid gap-3 p-6 md:w-[400px] lg:w-[500px] lg:grid-cols-[.75fr_1fr]">
              ...
              <ListItem href="/docs/primitives/typography" title="Texture">
                Des textures libre de droit pour t'aider dans la création de
                contenu
              </ListItem>
