...
export default function Markdown({ content }: { content?: string }) {
    ...
    prose-headings:font-rubik prose-headings:font-semibold prose-headings:tracking-tight prose-headings:text-white prose-headings:mt-12 prose-headings:mb-4
    ...
    prose-ul:mb-6 md:prose-ul:mt-4 prose-ul:list-none prose-ul:pl-0
