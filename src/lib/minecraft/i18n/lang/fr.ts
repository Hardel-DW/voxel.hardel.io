export const french = {
    ...
    "tools.warning.no_elements": "Aucun élément trouvé dans le data pack",
    "tools.warning.no_file": "Aucun fichier sélectionné",
    "tools.warning.multiple_files": "Un seul fichier peut être sélectionné",
    "tools.warning.invalid_file": "Fichier invalide, veuillez sélectionner un fichier .zip",

    "tools.error.failed_to_fetch_datapack": "Impossible de récupérer le data pack",
    "tools.error.failed_to_parse_datapack": "Impossible d'obtenir les informations du data pack",
    "tools.error.failed_to_get_pack_format": "Impossible d'obtenir le format du data pack",
    "tools.error.failed_to_get_datapack_description": "Impossible d'obtenir la description du data pack",
    "tools.error.impossible_to_read_file": "Impossible de lire le fichier",
    "tools.error.failed_to_get_pack_mcmeta": "Impossible d'obtenir la version du data pack",
    "tools.error.no_analyser": "Aucun analyseur trouvé pour cette version",
    ...
    "tools.enchantments.section.global.components.anvilCost.description": "Le coût de combinaison de deux objets avec cet enchantement.",
    ...
    "tools.enchantments.section.addons.dnt.illager_outpost.description": "L'enchantement sera trouvable dans les avant-postes des Illagers",
    ...
    "tools.enchantments.section.exclusive.set.mining.description": "Contiens tous les enchantements exclusifs pour l'exploitation minière.",
    ...
    "enchantment.component.tag_viewer.title": "Chargement des données",
    "enchantment.component.tag_viewer.description": "Affiche les tags de l'enchantement",
    "enchantment.component.tag_viewer.loading": "Recherche des éléments du jeu...",
